...
fig.suptitle("Parte Reale, Immaginaria e Spettro di Potenza della FFT del Sin")
# fig.suptitle("Parte Reale, Immaginaria e Spettro di Potenza della FFT dell'Onda Quadra")
# fig.suptitle("Parte Reale, Immaginaria e Spettro di Potenza della FFT dell'Onda Triangolare")
...
ax[2, 0].set_xlim(-100, 2000)
ax[2, 1].set_xlim(-100, 2000)
ax[2, 2].set_xlim(-100, 2000)
